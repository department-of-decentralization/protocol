  ...
  return (
    <main className="my-24">
      ...
      <section>
        ...
        <p>
          We are delighted that you have chosen to visit our website or take part at one of our events. We take our data
          protection responsibilities with the utmost seriousness and we have designed our website so that you may
          navigate and use our website without having to provide any data.
        </p>
        <p>
          This policy sets out what data we collect (if any), how we process it, and how long we retain it. This policy
          is applying to all of our processing activities where we act as a data controller.
        </p>
        <h3 className="font-bold">How we use data</h3>
        <p>
          We may collect and process data that you provide to us for the purpose of onboarding you as an attendee. This
          data may include:
        </p>
        ...
        <p>
          This data is collected in order to communicate with you. The legal basis for this processing is that it is
          necessary to fulfill a contract with you and your consent given in the attendee application.
        </p>
        <h3 className="font-bold">Use of third-party applications</h3>
        <p>We use the following third party applications:</p>
        <ul className="list-disc pl-6">
          <li>
            GitHub: used to host our websites through GitHub pages. GitHub might see your IP address if you read this.{" "}
            <a
        ...
        <p>
          ...
          by our organizing committee in Berlin. Also will the information be stored in Germany-based servers.
        </p>
        <h3 className="font-bold">Existence of automated decision-making</h3>
        ...
        <p>
          ...
          used or accessed in any unauthorized way, altered or disclosed. In addition, we limit access to your personal
          data to our core team only.
        </p>
        <p>
        ...
        <h3 className="font-bold">Your rights as a subject</h3>
        <p>
          You have certain rights under applicable legislation, and in particular under Regulation EU 2016/679 (General
          Data Protection Regulation or 'GDPR'). We explain these below. You can find out more about the GDPR and your
          rights by accessing the{" "}
        ...
        <p>
          ...
          information as to the source) and this policy intends to provide the information. Of course, if you have any
          further questions you can contact us on the above details.
        </p>
        <p>
        ...
        <p>
          ...
          set out in this policy, or need to advise us of any changes to your personal information, or would like any
          more information about the way in which we collect and use your data, please contact us at the above details.
        </p>
        <p>
          You have the general right to request the erasure of your personal information at any time. We will proceed to
          comply with an erasure request without delay.
        </p>
        ...
        <p>
          ...
          an update to this policy or applicable terms of business, etc.) will solely be directed at our attendees, and
          such communications generally do not offer an option to unsubscribe as they are necessary to provide the
          services requested.
        </p>
        ...
        <p>
          If we have not responded to you within a reasonable time or if you feel that your complaint has not been
          resolved to your satisfaction, you are entitled to make a complaint to the Data Protection Commissioner under
          the Data Protection Act which is
          <em> Berliner Beauftragte für Datenschutz und Informationsfreiheit</em>: Friedrichstr. 219, Guest entrance:
          Puttkamerstr. 16 - 18 (5th floor), Phone: 030 13889-0, Fax: 030 2155050, Email: mailbox@datenschutz-berlin.de
        </p>
        <p>
        ...
        <h3 className="font-bold">Storing data</h3>
        <p>
        ...
        <p>
          We may make changes to this policy from time to time. We encourage you to review the policy whenever you
          access or use our website to stay informed about our information practices and the choices available to you.
          If you do not agree to the revised policy, you should discontinue your use of this website.
        </p>
        <h3 className="font-bold">Our details</h3>
        <p>This website is operated by the Department of Decentralization.</p>
        <p>
          If you have any queries concerning your rights under this policy, please contact us via:{" "}
          <a href="mailto:hello@protocol.berlin">hello@protocol.berlin</a>
        </p>
      </section>
      <p className="ml-12">
...
export const Head = () => <title>Protocol Berg - Privacy Policy</title>;
