...
const IndexPage = ({ pageContext: { confirmedSpeakers } }) => {
  ...
  return (
    <main>
      ...
      <section>
        ...
        {confirmedSpeakers && confirmedSpeakers.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {confirmedSpeakers.map((speaker, i) => (
              <Speaker key={speaker.code} speaker={speaker} index={i} />
            ))}
          </div>
        ) : (
          ""
      ...
      <section>
        ...
        <p>
          ...
          <span className="ml-12">
            Bsky Staging:{" "}
            <a
              href="https://staging.bsky.app/profile/protocol.berlin"
              target="_blank"
            >
              @protocol.berlin
            </a>
