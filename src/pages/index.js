...
const IndexPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="sm:min-w-[32rem] font-mono flex flex-col items-center justify-center gl">
          <button
            className="flex flex-row items-center justify-center px-3  bg-[#8b0000] hover:bg-[#b22222] text-2xl text-white rounded-[4px]"
            onClick={closeModal}
          >
            <img src={key} className="h-[4.5rem]" />
            open
          </button>
          <div className=" mt-4">
            <a
              href="https://sci-hub.ru/donate"
              target="__blank"
              className="text-sm"
            >
              donate to Sci-hub
